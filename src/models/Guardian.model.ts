...
export interface IGuardian extends Document {
    ...
    fatherName: string;
    fatherNID: string;
    fatherPhone?: string; // optional if mother is main guardian
    ...
    // Main Guardian (could be father, mother, uncle, etc.)
    guardianName: string;
    guardianNID: string;
    guardianPhone: string;
    guardianRelation: 'Father' | 'Mother' | 'Uncle' | 'Aunt' | 'Grandfather' | 'Grandmother' | 'Other';
...
GuardianSchema.virtual('isParentGuardian').get(function (this: IGuardian) {
...
const Guardian = model<IGuardian>('Guardian', GuardianSchema);
