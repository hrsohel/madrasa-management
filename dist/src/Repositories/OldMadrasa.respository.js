...
class OldMadrasaRepository extends BaseRepository_1.BaseRepository {
    ...
    async updateOldMadrasaInfo(bodyData, session) {
        return await OldMadrasaInfo_model_1.default.findOneAndUpdate({ _id: bodyData._id }, { $set: bodyData }, { new: true, session });
    }
}
